/**
 * Admin doctor clinic workspace links (migration 053).
 *   npm run db:apply-admin-doctor-clinic-links
 */
...
const migrationFile = '053_admin_doctor_clinic_links.sql';
...
console.log('Applying admin doctor clinic links migration (053)…');
...
if (connectionStrings.length === 0) {
  console.error(
    'Missing SUPABASE_DB_PASSWORD. Run supabase/migrations/053_admin_doctor_clinic_links.sql in SQL Editor.'
  );
  process.exit(1);
}
...
console.log('Admin doctor clinic links migration applied successfully.');
