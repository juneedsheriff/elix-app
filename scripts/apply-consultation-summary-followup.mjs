/**
 * Consultation summary follow-up date column (migration 075).
 *   npm run db:apply-consultation-summary-followup
 */
...
const migrationFile = '075_consultation_summary_followup_date.sql';
...
console.log('Applying consultation summary follow-up date (075)…');
...
console.log('Doctors can save a follow-up date on consultation summaries.');
