/**
 * Visible clinic doctors appear in global patient search (migration 061).
 *   npm run db:apply-clinic-doctors-global
 */
...
const migrationFile = '061_clinic_doctors_global_visibility.sql';
...
console.log('Applying clinic doctors global visibility (061)…');
...
if (connectionStrings.length === 0) {
  console.error(
    'Missing SUPABASE_DB_PASSWORD. Run supabase/migrations/061_clinic_doctors_global_visibility.sql in SQL Editor.'
  );
  process.exit(1);
}
...
console.log('Clinic doctors global visibility applied successfully.');
