/**
 * Fix opinion_request_recommendations RLS for clinic PSE and administrators (migration 068).
 *   npm run db:apply-recommendations-rls
 */
...
const migrationFile = '068_recommendations_rls_clinic_pse.sql';
...
console.log('Applying recommendations RLS fix (068)…');
...
console.log('Clinic PSE and administrators can now save doctor recommendations.');
