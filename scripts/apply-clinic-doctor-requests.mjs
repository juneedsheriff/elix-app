/**
 * Clinic PSE doctor request workflow (migration 049).
 *   npm run db:apply-clinic-doctor-requests
 */
...
const migrationFile = '049_clinic_doctor_requests.sql';
...
console.log('Applying clinic doctor requests migration (049)…');
...
if (connectionStrings.length === 0) {
  console.error(
    'Missing SUPABASE_DB_PASSWORD. Run supabase/migrations/049_clinic_doctor_requests.sql in SQL Editor.'
  );
  process.exit(1);
}
...
console.log('Clinic doctor requests migration applied successfully.');
