/**
 * PSE clinic home care toggle (migration 080).
 *   npm run db:apply-pse-clinic-home-care
 */
...
const migrationFile = '080_pse_clinic_home_care_enabled.sql';
...
console.log('Applying PSE clinic home care enabled (080)…');
...
console.log('Clinic PSE home care can be enabled or disabled per clinic workspace.');
