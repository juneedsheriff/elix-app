/**
 * Patient doctor browse RPC + RLS repair (migration 062).
 *   npm run db:apply-patient-browse-doctors
 */
...
const migrationFile = '062_patient_browse_doctors_rpc.sql';
...
console.log('Applying patient browse doctors RPC (062)…');
...
if (connectionStrings.length === 0) {
  console.error(
    'Missing SUPABASE_DB_PASSWORD. Run supabase/migrations/062_patient_browse_doctors_rpc.sql in SQL Editor.'
  );
  process.exit(1);
}
...
console.log('Patient browse doctors RPC applied successfully.');
