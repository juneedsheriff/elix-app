/**
 * Admin visibility for clinic PSE patients (migration 056).
 *   npm run db:apply-admin-clinic-patients
 */
...
const migrationFile = '056_admin_clinic_patients_visibility.sql';
...
console.log('Applying admin clinic patients visibility (056)…');
...
console.log('Administrators can now see clinic PSE patients.');
