/**
 * Patient soft delete for admin management (migration 067).
 *   npm run db:apply-patient-soft-delete
 */
...
const migrationFile = '070_patient_claim_respect_disabled.sql';
...
console.log('Applying patient claim disabled guard (070)…');
...
console.log('Claim login no longer re-enables deleted or disabled patient profiles.');
