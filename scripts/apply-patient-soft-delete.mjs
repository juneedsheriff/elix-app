...
const migrationFile = '067_patient_soft_delete.sql';
...
console.log('Applying patient soft delete (067)…');
...
console.log('Administrators can soft-delete patients from the admin console.');
