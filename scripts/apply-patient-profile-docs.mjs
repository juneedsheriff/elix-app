/**
 * Patient govt ID / pin / prescription document columns (migration 076).
 *   npm run db:apply-patient-profile-docs
 */
...
const migrationFile = '076_patient_govt_id_pin_prescriptions.sql';
...
console.log('Applying patient profile docs fields (076)…');
...
console.log('Patient govt ID, pin code, and prescription document columns are ready.');
