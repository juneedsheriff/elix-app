/**
 * Home care remarks + follow-up date columns (migration 074).
 *   npm run db:apply-home-care-followup
 */
...
const migrationFile = '074_home_care_remarks_followup.sql';
...
console.log('Applying home care remarks/follow-up (074)…');
...
console.log('Clinic PSE can save home care remarks and follow-up dates for patients.');
