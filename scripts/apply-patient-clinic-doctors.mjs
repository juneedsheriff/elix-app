/**
 * Clinic patients can browse doctors in their PSE clinic workspace (migration 060).
 *   npm run db:apply-patient-clinic-doctors
 */
...
const migrationFile = '060_patient_clinic_doctors_select.sql';
...
console.log('Applying patient clinic doctors SELECT policy (060)…');
...
if (connectionStrings.length === 0) {
  console.error(
    'Missing SUPABASE_DB_PASSWORD. Run supabase/migrations/060_patient_clinic_doctors_select.sql in SQL Editor.'
  );
  process.exit(1);
}
...
console.log('Patient clinic doctors policy applied successfully.');
