/**
 * Clinic PSE create-request trigger fix (migration 048).
 *   npm run db:apply-clinic-pse-create-requests
 */
...
const migrationFile = '048_clinic_pse_create_requests.sql';
...
console.log('Applying clinic PSE create-request migration (048)…');
...
if (connectionStrings.length === 0) {
  console.error(
    'Missing SUPABASE_DB_PASSWORD. Run supabase/migrations/048_clinic_pse_create_requests.sql in SQL Editor.'
  );
  process.exit(1);
}
...
console.log('Clinic PSE create-request migration applied successfully.');
