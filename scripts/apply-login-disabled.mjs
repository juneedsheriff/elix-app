/**
 * Applies 015_login_disabled_flags.sql
 *   npm run db:apply-login-disabled
 */
...
const sql = readFileSync(join(root, 'supabase/migrations/015_login_disabled_flags.sql'), 'utf8');
...
console.log('Applying 015_login_disabled_flags.sql…');
