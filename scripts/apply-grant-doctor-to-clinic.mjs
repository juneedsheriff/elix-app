/**
 * Admin grant doctor to clinic workspace (migration 054).
 *   npm run db:apply-grant-doctor-to-clinic
 */
...
const migrationFile = '054_grant_doctor_to_clinic.sql';
...
console.log('Applying grant doctor to clinic migration (054)…');
...
if (connectionStrings.length === 0) {
  console.error(
    'Missing SUPABASE_DB_PASSWORD. Run supabase/migrations/054_grant_doctor_to_clinic.sql in SQL Editor.'
  );
  process.exit(1);
}
...
console.log('Grant doctor to clinic migration applied successfully.');
