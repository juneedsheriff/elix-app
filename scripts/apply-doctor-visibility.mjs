/**
 * Applies 018_doctor_visibility.sql (admin hide/delete controls for doctors).
 *   npm run db:apply-doctor-visibility
 */
...
const sql = readFileSync(join(root, 'supabase/migrations/018_doctor_visibility.sql'), 'utf8');
...
console.log('Applying 018_doctor_visibility.sql...');
...
for (const connectionString of urls) {
  ...
  try {
    ...
    console.log('Done. Admins can hide and delete doctors from patient search.');
    process.exit(0);
  } catch (error) {
    lastError = error;
  } finally {
