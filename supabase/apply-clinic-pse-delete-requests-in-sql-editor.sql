-- Run in Supabase SQL Editor if npm run db:apply-clinic-pse-delete-requests is unavailable.
-- Migration 071: clinic PSE may delete clinic-scoped opinion requests
