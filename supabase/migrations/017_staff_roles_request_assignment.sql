-- Staff roles (Administrator / Patient Service Executive) and request assignment workflow
...
-- Any active staff row (administrator or PSE) — keeps existing is_admin() callers working for staff access
...
-- Staff can read patient profiles; only administrators can update
